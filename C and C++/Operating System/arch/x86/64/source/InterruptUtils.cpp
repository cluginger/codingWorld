...
extern "C" void irqHandler_0()
{
  ...
  if(Scheduler::instance()->getTicks() == 2)
    Scheduler::instance()->rdtscOld = Scheduler::instance()->getRdtscTicks();
  else if(Scheduler::instance()->getTicks() >= 2)
    Scheduler::instance()->setTime();

  if(Scheduler::instance()->getTicks() % 30 == 0)
    Scheduler::instance()->shiftAge();
//  kprintf("%ld\n", Scheduler::instance()->getTicks());
