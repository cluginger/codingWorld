...
class ProcessRegistry : public Thread
{
  public:
    ...
    size_t getAndEnhancePIDCounter();
    void switchASLRStatus();
    size_t pid_counter = 0;
    Condition waitpid_cond;
    Mutex waitpid_lock;
    Mutex PID_lock;
    Mutex processMap_lock;
    Mutex deadProcessMap_lock;
    bool isAslrModeOn = false;
    Mutex aslrModeLock;
    ustl::map<size_t, UserProcess*> processMap;
    ustl::map<size_t, size_t> deadProcessMap;
