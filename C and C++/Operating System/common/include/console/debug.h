...
const size_t CANCEL             = Ansi_Green   | OUTPUT_ENABLED;
//const size_t EXECV              = Ansi_Red     | OUTPUT_ENABLED;
const size_t JOIN               = Ansi_Green   | OUTPUT_ENABLED;
const size_t DETACH             = Ansi_Green   | OUTPUT_ENABLED;
const size_t ARCHMEM            = Ansi_Yellow  | OUTPUT_ENABLED;
const size_t PRAs               = Ansi_Cyan    | OUTPUT_ENABLED;
const size_t HEAP               = Ansi_Red     | OUTPUT_ENABLED;
const size_t LOL                = Ansi_Red    | OUTPUT_ENABLED;
//const size_t PRAsNFU            = Ansi_Cyan     | OUTPUT_ENABLED;
const size_t PRAsNFU            = Ansi_Cyan;
const size_t PRAsAGING          = Ansi_Cyan     | OUTPUT_ENABLED;
const size_t PRAsSEC          = Ansi_Cyan     | OUTPUT_ENABLED;
const size_t PRAsRANDOM         = Ansi_Cyan     | OUTPUT_ENABLED;
...
//group arch
const size_t A_BOOT             = Ansi_Yellow;
...
//
const size_t FORK                = Ansi_Yellow | OUTPUT_ENABLED;
const size_t GROW                = Ansi_Yellow | OUTPUT_ENABLED;
const size_t WAIT                = Ansi_Yellow | OUTPUT_ENABLED;

//SWAPPING
//const size_t SWAP                = Ansi_Magenta | OUTPUT_ENABLED;
//const size_t SWAPIN_HANDLE       = Ansi_Cyan  | OUTPUT_ENABLED;
//const size_t SWAPOUT_HANDLE      = Ansi_Green | OUTPUT_ENABLED;
//const size_t SWAPIN_REQUEST      = Ansi_Cyan  | OUTPUT_ENABLED;
//const size_t SWAPOUT_REQUEST     = Ansi_Green  | OUTPUT_ENABLED;
//const size_t IPT_DEBUG           = Ansi_Yellow| OUTPUT_ENABLED;
//const size_t SPT                 = Ansi_Yellow | OUTPUT_ENABLED;
//const size_t SPT_TABLE           = Ansi_Yellow| OUTPUT_ENABLED;
//const size_t IPT_TABLE           = Ansi_Yellow | OUTPUT_ENABLED;
//const size_t DIRTY               = Ansi_Red | OUTPUT_ENABLED;
//const size_t USED_PPNs          = Ansi_Magenta | OUTPUT_ENABLED;

const size_t USED_PPNs          = Ansi_Magenta;
const size_t SWAP                = Ansi_Magenta;
const size_t SWAPIN_HANDLE       = Ansi_Cyan;
const size_t SWAPOUT_HANDLE      = Ansi_Green;
const size_t SWAPIN_REQUEST      = Ansi_Cyan;
const size_t SWAPOUT_REQUEST     = Ansi_Green;
const size_t IPT_DEBUG           = Ansi_Yellow;
const size_t SPT                 = Ansi_Yellow ;
const size_t SPT_TABLE           = Ansi_Yellow;
const size_t IPT_TABLE           = Ansi_Yellow ;
const size_t DIRTY               = Ansi_Red;

const size_t ARCHMEM_MAPPING     = Ansi_Blue  | OUTPUT_ENABLED;