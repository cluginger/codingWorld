...
// else...
  ...
  {
    case KEY_F3:
      kprintf("IPT printed in Terminal\n");
      IPT::instance()->printIPT();
      break;
    case KEY_F4:
      kprintf("SPT printed in Terminal\n");
      SwapManager::instance()->printSPT();
      break;
    case KEY_F5:
      SwapManager::instance()->printUsedBlocksOnDisk();
      break;
    case KEY_F6:
      ProcessRegistry::instance()->switchASLRStatus();
      break;
    case KEY_F7:
      PRA::instance()->printPRAinfo();
      break;
    case KEY_F8:
      PRA::instance()->switchCurrentPRA();
      break;
    case KEY_F9:
