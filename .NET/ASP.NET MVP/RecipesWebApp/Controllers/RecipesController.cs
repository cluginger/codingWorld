...
namespace RecipesWebApp.Controllers
{
    public class RecipesController : Controller
    {
        ...
        // GET: Recipes/SearchRecipeForm
        public async Task<IActionResult> SearchRecipeForm()
        {
            return View();
        }

        // POST: Recipes/SearchRecipeResult
        public async Task<IActionResult> SearchRecipeResult(string SearchPhrase)
        {
            return View("Index",await _context.Recipe.Where(j => j.name.Contains(SearchPhrase)).ToListAsync());
        }
